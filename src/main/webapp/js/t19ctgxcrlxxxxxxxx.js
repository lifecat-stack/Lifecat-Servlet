...
(function (e, t) {
    ...
    x.fn.load = function (e, n, r) {
        ...
        ajaxSettings: {
            ...
            processData: !0,
            async: !0,
            contentType: "application/x-www-com.wang.form-urlencoded; charset=UTF-8",
            accepts: {
                "*": Dn,
                text: "text/plain",
                html: "text/html",
    ...
    x.ajaxSetup({
        ...
        var o, a, s,
            l = n.jsonp !== !1 && (Bn.test(n.url) ? "url" : "string" == typeof n.data && !(n.contentType || "").indexOf("application/x-www-com.wang.form-urlencoded") && Bn.test(n.data) && "data");
