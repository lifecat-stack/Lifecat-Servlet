 ...
 * @auther ten
 */
public class ImageManagerImpl implements Manager {
    private final int userid;
    private final ImageDAO dao;
    private final Logger logger;

    private ImageManagerImpl(int userid) {
        this.userid = userid;
        this.dao = (ImageDAO) JdbcDAOFactory.getDAOByName("ImageDAO");
        this.logger = Logger.getLogger("ImageManagerImpl@" + userid);
    }

    static Manager getImageModel(int userid) {
        return new ImageManagerImpl(userid);
    }
